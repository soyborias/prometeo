...
<html class="no-js" lang="es">
  <head>
    ...
    <title>Crear Sucursales P&G</title>
  ...
  <body>
    ...
    <div class="left-sidebar show-for-large-up">
        <ul class="property-nav text-center">
          <li>
            <a href="" data-tooltip aria-haspopup="true" class="tip-right" title="Usuario"><i class="fa fa-user"></i></a>
          </li>
          <li class="current">
            <a href="dashboard-admin.php" data-tooltip aria-haspopup="true" class="tip-right" title="Entrenamientos"><i class="fa fa-graduation-cap"></i></a>
          </li>
          <li>
          ...
          <div class="row text-left">
            <form>
              ...
              <div class="small-12 medium-6 columns">
                ...
                <div class="row">
                  <div class="large-12 columns">
                    <h4 class="azulMain">CREAR SUCURSAL</h4><hr class="mTop0" />
                  </div>
                  ...
                  <div class="large-12 columns">
                    <label>Descripción
                      <input type="text" placeholder="Descripción de la Sucursal" />
                    </label>
                  </div>

                  <div class="large-12 columns">
                    <div class="clearfix">
                      <a class="small round button success">GRABAR</a>
                    </div>
                  </div>
                </div>
              ...
              <div class="small-12 medium-6 columns">
                ...
                <div class="row">
                  ...
                  <div class="large-12 columns">
                    <h4 class="azulMain">SUCURSALES</h4><hr class="mTop0" />
                  </div>
