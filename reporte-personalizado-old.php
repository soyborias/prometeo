...
if ( (isset($_SESSION['username'])) && ( $_SESSION['rol'] == ROL_ADMIN || $_SESSION['rol'] == ROL_SUPERVISOR ) ){
  ...
  switch ($type) {
    case 'entrenamiento':
      ...
      $resRpt  = getEntrenamientoRpt($_SESSION['equipo_filtro'], $db);
    ...
    case 'acumulado':
      ...
      if (in_array('a', $pk2)){
        $resRpt  = getEntrenamientoRptByDis($_SESSION['equipo_filtro'], $db);
    ...
    case 'vendedores':
      ...
      $resRpt  = getEntrenamientoRptByVendedor('', $db);
            ...
            <div class="small-12 medium-4 columns">
              <form id="frmEntrenamiento" action="" method="POST">
                ...
                <ul class="pLeft1 no-bullet">
                  ...
                  <li><input type="checkbox" name="pk1[]" value="c" id="pk1c"><label for="pk1c">Completados</label></li>
                  <li><input type="checkbox" name="pk1[]" value="d" id="pk1d"><label for="pk1d">% Completados</label></li>
