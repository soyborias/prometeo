...
if (isset($_SESSION['username'])){
  ...
  $arrGame = array('url' => 'juego2.php?pid='. $pidE, 'link' => 'Desafio 2' );
  $bread   = genBreadCrumbs('dashboard', 5, 'Desafio 2', $arrGame, $linaje);
} else {
  // User No logeado
      ...
      <div class="row pTop1">
        <div class="medium-12 columns">
          <div class="text-left">
            ...
            <h1 class="m0 azulMain">DESAFIO 2</h1>
            <h5 class="subheader azulSub">INSTRUCCIONES: Arrastra la respuesta correcta donde Don Pepe para resolver el juego</h5>
          </div>
          <hr class="mTop0" />
          ...
          <div class="row">
            <div id="juego">
              ...
              <img src="static/images/juegos/juego02.png" alt="Juego">

              <div id="caja2" class="suelta" class="suelta btn btn-default" role="button">
                <span><?php print($question); ?></span>
              </div>

              <div id="elemento-a" class="objeto arrastrable cajaColor">
                <h3 class="blanco"><i class="fa fa-lightbulb-o"></i></h3>
                <h4 class="blanco"><?Php print($rptas['a']); ?></h4>
              </div>

              <div id="elemento-b" class="objeto arrastrable cajaColor">
                <h3 class="blanco"><i class="fa fa-lightbulb-o"></i></h3>
                <h4 class="blanco"><?Php print($rptas['b']); ?></h4>
              </div>

              <div id="elemento-c" class="objeto arrastrable cajaColor">
                <h3 class="blanco"><i class="fa fa-lightbulb-o"></i></h3>
                <h4 class="blanco"><?Php print($rptas['c']); ?></h4>
              </div>

              <div id="elemento-d" class="objeto arrastrable cajaColor">
                <h3 class="blanco"><i class="fa fa-lightbulb-o"></i></h3>
                <h4 class="blanco"><?Php print($rptas['d']); ?></h4>
              </div>
...
<div id="juegoNext" class="reveal-modal msgOk" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  <div class="msgDialog">
    <?php print($puntos); ?><hr/>
    <p>Superaste los 5 niveles, ahora pasa al siguiente nivel</p>
    <a href="ejercicio.php?pid=<?php print $pidE; ?>" class="btnMsg button large round info">Avanzar</a>
  </div>
</div>
...
<div id="juegoOk" class="reveal-modal msgOk" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  <div class="msgDialog">
    <?php print($puntos); ?><hr/>
    <p>BENEFICIO AL CLIENTE: <?php print($ganancia1); ?><br/>
    BENEFICIO AL VENDEDOR: <?php print($ganancia2); ?></p>
...
<div id="juegoFeedback" class="reveal-modal msgBad" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  <div class="msgDialog">
    ...
    <p>PERJUICIO AL CLIENTE: <?php print($perdida1); ?></br>
      PERJUICIO AL VENDEDOR: <?php print($perdida2); ?></p>
    <a href="juego2.php?pid=<?php print $pidE; ?>&retry=<?php print $pidE; ?>" class="btnMsg button large round info">Reiniciar</a>
  </div>
</div>
...
<script>
  ...
  function grabarWin(){
    mp3Ok.play();
     if (last == 1) {
      grabarGame("saveGameWin", $('#juegoNext'));
  ...
  function grabarAccion(hito, hitoID){
    $.post(ajaxReq, {action:"updateAction", eAuth:auth, eGame:game, eHito:hito, eHitoID:hitoID, eTabla:mTbl, eTblNext:nextTB, eRel:mID, eLinaje:linaje, eStatus:estado, ePid:pid, rand:Math.random()},
    function(data){
