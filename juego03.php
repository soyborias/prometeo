...
if (isset($_SESSION['username'])){
  ...
  $resultados = getJuegoRnd($pid, 3, 1, $repetidos, $db);
  ...
  $arrGame = array('url' => 'juego03.php?rel='. $rel. '&pid='. $pidE, 'link' => 'Desafio 3' );
      ...
      <div class="row pTop1">
        <div class="medium-12 columns">
          <div class="text-left">
            ...
            <h1 class="m0 azulMain">DESAFIO 3 <span class="round label"><?php print $juego_puntos; ?></span></h1>
...
<div id="juegoOk" class="reveal-modal msgOk" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog" style="background: url('/code/show-image.php?p=ok&i=gana') top center no-repeat;">
  <div class="msgDialog">
    <?php print($puntos); ?><hr/>
    <a href="juego03.php?rel=<?php print($nextRel); ?>&pid=<?php print $pidE; ?>&retry=<?php print $pid; ?>" class="btnMsg button large round info">Avanzar</a>
  </div>
</div>
