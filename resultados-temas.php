...
$pidE  = (isset($_POST['pid'])) ? $_POST['pid'] : 0;
...
if ( (isset($_SESSION['username'])) && ( $_SESSION['rol'] == ROL_ADMIN || $_SESSION['rol'] == ROL_SUPERVISOR || $_SESSION['rol'] == ROL_JEFE ) ){
  ...
  $filter = '';
  $equipo   = (isset($_POST['fEquipo']))   ? $_POST['fEquipo']   : -1;
  $perfil   = (isset($_POST['fPerfil']))   ? $_POST['fPerfil']   : -1;
  $distro   = (isset($_POST['fDistribuidora']))   ? $_POST['fDistribuidora']   : -1;
  $sucursal = (isset($_POST['fSucursal'])) ? $_POST['fSucursal'] : -1;
  ...
  $firtsC  = firtsCurso($pid, $db);
  #$resRpt  = getEntrenamientoTemasRpt($_SESSION['equipo_filtro'], $_SESSION['perfil_filtro'], $pid, $firtsC, $db);
  $resRpt  = getEntrenamientoTemasRpt($_SESSION['equipo_filtro'], $_SESSION['perfil_filtro'], $filter, $firtsC, $db);
  $tblRpt  = genResultadosTemasTR($resRpt);
                      ...
                      <caption>
                        <div class="row">
                          <div class="small-12 columns text-center">
                            <h4 class="blanco">REPORTE POR TEMAS</h4>
                          </div>
                        </div>
                      </caption>
                      <thead>
