...
if ( (isset($_SESSION['username'])) && ( $_SESSION['rol'] == ROL_ADMIN || $_SESSION['rol'] == ROL_SUPERVISOR || $_SESSION['rol'] == ROL_JEFE ) ){
  ...
  $resRpt  = getEntrenamientoRpt($_SESSION['equipo_filtro'], $_SESSION['perfil_filtro'], $db);
          ...
          <div class="row">
            <div class="small-12 columns text-left">
              <ul class="button-group small round mDown1">
                ...
                <li><a href="reporte-entrenamiento.php" class="button bgVerdeL m0 active">Entrenamiento</a></li>
