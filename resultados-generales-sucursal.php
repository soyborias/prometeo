...
if ( (isset($_SESSION['username'])) && ( $_SESSION['rol'] == ROL_ADMIN || $_SESSION['rol'] == ROL_SUPERVISOR || $_SESSION['rol'] == ROL_JEFE ) ){
  ...
  $resRpt  = getEntrenamientoRptByCity_v2($_SESSION['equipo_filtro'], $db);
  $tblRpt  = genReporteGeneralCityTR_v2($resRpt);
          ...
          <div class="row">
            <div class="small-12 columns">
              <ul class="button-group round small">
                ...
                <li><a href="resultados-generales-sucursal.php" class="button bgVerdeL active">Sucursal</a></li>
